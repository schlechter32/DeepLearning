...
\includegraphics[page = 72, width = \paperwidth]{PDFs/DL-Slides.pdf}
\includepdf[pages={73-76}, scale = 1,nup = 1x2 ]{PDFs/DL-Slides}
\includegraphics[page = 77, width = \paperwidth]{PDFs/DL-Slides.pdf}
\putfigure{1.0}{1}{0.4}{Images/vlc_YAS4jaJ0JB}{Vector Normes}
\section{Random variable and probability distribution}
\includegraphics[page = 78, width = \paperwidth]{PDFs/DL-Slides.pdf}
\includepdf[pages={79-88}, scale = 1,nup = 1x2 ]{PDFs/DL-Slides}
\includegraphics[page = 89, width = \paperwidth]{PDFs/DL-Slides.pdf}
...
\includegraphics[page = 90, width = \paperwidth]{PDFs/DL-Slides.pdf}
\includepdf[pages={91-94}, scale = 1,nup = 1x2 ]{PDFs/DL-Slides}
\includegraphics[page = 95, width = \paperwidth]{PDFs/DL-Slides.pdf}
...
\includegraphics[page = 96, width = \paperwidth]{PDFs/DL-Slides.pdf}
\includepdf[pages={97-98}, scale = 1,nup = 1x2 ]{PDFs/DL-Slides}
